...
<div class="w3-top">
  <div class="w3-bar w3-white w3-padding w3-card-2" style="letter-spacing:4px;">
    <a href="#home" class="w3-bar-item w3-button">Expert System of Thesis Title Topic Selection with Forward Chaining Method</a>
    <!-- Right-sided navbar links. Hide them on small screens -->
  <div class="w3-right w3-hide-small">		
	<a href="aboutt.php?p=#about" class="w3-bar-item w3-button">About System</a>
	<a href="carii.php?p=#cari" class="w3-bar-item w3-button">Search Topic</a>
...
<B><marquee><h3>Welcome COLLEGE STUDENTS! On this website, you can search thesis title topic freely </b></marquee></h3>
...
<table border="" class ="w3-col 16 w3-padding-large"><tr>
<Tr>
	<Td><iframe class="iframe" src="pakar2.php?idpertanyaan=P01" width="1000" height="300"></iframe></td>
</tr></table>
</div>
  ...
  <tr class="w3-light-grey">
    ...
    <th><img src="images/tutor/tutoreng/11.jpg" width="100%" height="400"><Br><Br><Br><center>Step 1: Go To Main Menu, then choose Search Topic Menu to start looking for thesis title topic&nbsp&nbsp&nbsp <a href="http://localhost:8080/fix/stepp2.php#tutor"><button>Step 2</a></button></img></th>
  </tr>
</table>
