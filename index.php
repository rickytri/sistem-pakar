...
<div class="w3-top">
  <div class="w3-bar w3-white w3-padding w3-card-2" style="letter-spacing:4px;">
    ...
    <a href="#home" class="w3-bar-item w3-button">Sistem Pakar Pemilihan Topik Judul Skripsi dengan Metode Forward Chaining</a>
  ...
  <div class="w3-right w3-hide-small">		
	...
	<a href="tutor.php?p=#tutor" class="w3-bar-item w3-button">Tutorial Pengguna</a>
...
<B><marquee><h3>Selamat Datang Para Mahasiswa dan selamat mencari topik judul skripsi </b></marquee></h3>
...
<div class="w3-col l6 w3-padding-large">
  ...
  <tr class="w3-light-grey">
    ...
    <th><img src="images/tutor/111.jpg" width="100%" height="400"><Br><Br><Br><center>Langkah 1: Masuk ke Menu Utama, lalu pilih Menu Cari Topik untuk Mulai mencari topik judul skripsi&nbsp&nbsp&nbsp <a href="http://localhost:8080/fix/step2.php#tutor"><button>Langkah 2</a></button></img></th>
  </tr>
</table>
