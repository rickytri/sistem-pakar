...
<body>
<form action="pakar2.php" method="get">
...
<div class="w3-top">
  ...
  <div class="w3-right w3-hide-small">		
	...
	<a href="#tutor" class="w3-bar-item w3-button">User Tutorial</a>
...
<div class="w3-col l6 w3-padding-large">
  ...
  <tr class="w3-light-grey">
    ...
    <th><img src="images/tutor/tutoreng/22.jpg" width="100%" height="400"><Br><Br><Br><center>&nbsp&nbsp&nbsp <a href="http://localhost:8080/fix/index2.php#tutor"><button>Step 1</a></button>&nbsp&nbsp Step 2: Choose an answer option between Yes and No on each question, and answer to finish to get the thesis title topic <a href="http://localhost:8080/fix/stepp3.php#tutor"><button>Step 3</a></button></img></th>
  </tr>
</table>
